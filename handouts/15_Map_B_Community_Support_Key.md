...
- **Logistics / Piloting:** Plan evacuation timing.
- **Mesh Hacker:** Prevent hostile floor lockout.
- **Grease Monkey:** Keep the lift stable under overload.
- **Performance:** Manage the crowd waiting for the lift.
...
- **Parkour / Athletics:** Move quickly under pressure.
- **Tactics:** Use it as a choke point.
- **Gutter Rat:** Know which landing bypasses the monitored hallway.
- **Melee Combat:** Recognize how dangerous a fight here would be.
